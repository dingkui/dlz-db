...
| 方法 | 返回类型                  | 说明 |
|------|-----------------------|------|
| `.queryBean()` | Bean / null           | 严格单条记录；无则返回 null，多条抛出异常 |
| `.queryFirstBean()` | Bean / null       | 非严格取第一条；无则返回 null |
| `.queryOne()` | ResultMap / null      | 严格单条记录；无则返回 null，多条抛出异常 |
| `.queryFirst()` | ResultMap / null      | 非严格取第一条；无则返回 null |
