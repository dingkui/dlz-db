...
| v6 路径 | v7 路径 |
|---------|---------|
| `com.dlz.db.config.DlzDbConfig` | `com.dlz.db.spring.config.DlzDbConfig` |
| `com.dlz.db.config.DlzDbProperties` | `com.dlz.db.spring.config.DlzDbProperties` |
...
| 版本号 | 6.x | 7.0.0 | 所有用户 |
| 配置类包路径 | `com.dlz.db.config.*` | `com.dlz.db.spring.config.*` | Spring Boot 用户 |
