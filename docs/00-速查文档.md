...
[📋 API 参考](./00-速查文档.md#-api-参考)
- [DB 类 API](./00-速查文档.md#db-类-api)
- [Wrapper 类 API](./00-速查文档.md#wrapper-类-api)
- [Condition 类 API](./00-速查文档.md#condition-类-api)
- [Page 类 API](./00-速查文档.md#page-类-api)
...
// 普通插入
DB.Pojo.insert(user).execute();  // Pojo 插入后自动回填主键到 user 对象
