...
public class HelperScan {
    private static ClassScanner classScanner = new com.dlz.db.core.NoOpClassScanner();

    public static void setClassScanner(ClassScanner scanner) {
        HelperScan.classScanner = scanner;
    }
    ...
    public static void scan(String packageName) {
        ...
        try {
            ...
            Set<Class<?>> set = classScanner.scan(packageName, TableName.class);
