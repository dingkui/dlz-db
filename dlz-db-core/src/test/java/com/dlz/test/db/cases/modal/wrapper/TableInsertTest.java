...
import com.dlz.db.wrapper.TableInsert;
...
public class TableInsertTest extends BaseDBTest {
    ...
    public void tableInsertTest1() {
        TableInsert insert = DB.table.insertWrapper("t_b_dict")
                .value("dict_name", "测试")
    ...
    public void tableInsertTest3() {
        ...
        TableInsert insert = DB.table.insertWrapper("t_b_dict").value(data);
        showSql(insert, "tableInsertTest3", "INSERT INTO t_b_dict(deleted,dict_status) VALUES(0,'1') ");

        TableInsert insert2 = DB.table.insertWrapper("t_b_dict").value(data);
