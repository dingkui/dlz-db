...
import com.dlz.test.db.mock.BaseMockTest;
...
class DbPojoTest extends BaseMockTest {
    ...
    void setUp() {
        ...
        BeanInfoHolder.getTableColumnsInfo("TEST_USER"); // 先触发一次以初始化缓存

        // 通过反射访问私有静态字段 tableColumnsInfoCache 并直接 put
        try {
